...
add_filter('the_content', 'wp_show_room_spy_page', 42);
...
$username = $_POST ['username']; 
	?>
    <style>#chat,.chatimages{margin:2px 6px 15px;width:220px;height:220px;-webkit-transition:all .3s ease;-moz-transition:all .3s ease;-o-transition:all .3s ease;-ms-transition:all .3s ease;transition:all .3s ease;display:inline-block;text-decoration:none;font-size:17px;-webkit-border-radius:14px;-moz-border-radius:14px;border-radius:6px}input[type=text]{width:25%;}</style>
<?php
